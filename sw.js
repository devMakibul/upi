...
const ASSETS = [
    ...
    '/assets/style.css',
    '/assets/themes.json',
    '/assets/backgrounds/bg-1.webp',
    '/assets/backgrounds/bg-2.webp',
    '/assets/backgrounds/bg-3.webp',
    '/assets/backgrounds/bg-4.webp',
    '/assets/backgrounds/bg-5.webp',
    '/assets/backgrounds/bg-6.webp',
    '/assets/backgrounds/bg-7.webp',
    '/assets/backgrounds/bg-8.webp',
    '/assets/backgrounds/bg-9.webp',
    '/assets/backgrounds/bg-10.webp',
    '/assets/backgrounds/bg-11.webp',
